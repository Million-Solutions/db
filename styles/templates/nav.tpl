    ...
    <section class="sidebar">
     ...
     /.search form -->
      ...
      <ul class="sidebar-menu">
        ...
        {if !isset($smarty.get.p) or $smarty.get.p == 'index'}
        ...
        {if isset($smarty.get.p) and $smarty.get.p == 'balances'}
        <li class="active treeview">
          {else}
          <li class="treeview">
          {/if}
        ...
        {if isset($smarty.get.p) and $smarty.get.p == 'tablon'}
        <li class="active treeview">
          {else}
          <li class="treeview">
          {/if}
        ...
        {if isset($smarty.get.p) and $smarty.get.p == 'graficos'}
        <li class="active treeview">
          {else}
          <li class="treeview">
          {/if}
